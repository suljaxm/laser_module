...
int main(int argc, char** argv)
{
    ...
    //TODO: (1~2 lines)
    J21J22 = (A.transpose() * A).colPivHouseholderQr().solve(A.transpose() * b);//Cholesky decomposition
    //end of TODO
    ...
    double r_R;
    //TODO: (3~5 lines)
    b_wheel = (C.transpose() * C).colPivHouseholderQr().solve(C.transpose() * S)(0);//Cholesky decomposition
    r_L = -J21*b_wheel;
    r_R = J22*b_wheel;
    //end of TODO
    cout << "b: " << b_wheel << endl;
